...
class Rating{
  ...
  async createNewRating(){
    ...
    // you'll need to check whether or not the product already has a comment associated with the comment or not. It's easy to do, just sleepy it's already 5:22Am
