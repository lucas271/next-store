...
export default function Footer(){
	return <>
		<footer className="text-center sm:text-left relative w-full bg-white h-min-[50vh] sm:h-min-[70vh] text-gray-600 ">
			...
			<span className="absolute bottom-2 text-slate-800 w-full text-center left-0">Feito por <Link href="https://github.com/lucas271?tab=repositories" target="_blank" className="font-bold hover:text-slate-950 transition duration-200">Lucas <AiOutlineSmile className="inline-block"/></Link> </span>
		</footer>
	</>
}