          ...
          cart.products.map(item => {
            return <div className="flex gap-2 justify-between items-center py-3 px-1 relative text-lg" key={item.product?.id}>
              ...
              <div className="utils flex gap-3">
                ...
                <button  disabled={item.product.loading} className="text-gray-800 hover:text-gray-950 transition duration-200" onClick={() => dispatch(addProduct(item.product?.id))}><BsFillArrowRightCircleFill/></button>
              </div>
