    ...
    <footer className="text-center sm:text-left relative w-full bg-white h-min-[50vh] sm:h-min-[70vh] text-gray-600 ">
      <div className="flex flex-col-reverse sm:flex-row justify-evenly w-[95%] sm:w-[90%] m-auto h-full gap-6 py-12 relative">
        <div className="flex-col flex gap-4 sm:text-xl text-lg">
          ...
          <StyledButton text="Enviar mensagem" className={"text-black sm:w-full w-[70%] text-lg m-auto"}/>
        </div>
      ...
      <span className="absolute bottom-0 text-slate-800 w-full text-center left-0">Feito por <a href="https://github.com/lucas271?tab=repositories" target="_blank" className="font-bold hover:text-slate-950 transition duration-200">Lucas <AiOutlineSmile className="inline-block"/></a> </span>
    </footer>
  </>
}